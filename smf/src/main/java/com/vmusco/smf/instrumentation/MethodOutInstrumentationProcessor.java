 ...
 */
public class MethodOutInstrumentationProcessor extends AbstractInstrumentationProcessor{
	...
	public boolean isThisLineInstrumented(String line) {
		return line.startsWith(TestingInstrumentedCodeHelper.ENDKEY);
	}
	...
	public String getLineIfInstrumented(String line) {
		if(!isThisLineInstrumented(line))
			...
			return line.substring(TestingInstrumentedCodeHelper.ENDKEY.length());
	}
}
